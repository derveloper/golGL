...
elseif(Gosu_FIND_QUIETLY)
    ...
    message("you are probably compiling gosu itself, otherwise you messed up")
endif()
...
#set(Gosu_LIBRARY_DIRS "${PREFIX}/lib")

set(Gosu_INCLUDE_DIR "${PREFIX}/include/Gosu/..")
...
set(Gosu_LIBRARY ${PREFIX}/lib/libGosu.a)
